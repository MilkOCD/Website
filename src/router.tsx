...
const Blank = Loader(lazy(() => import('src/content/dashboards/Blank')));

// Applications

const Article = Loader(lazy(() => import('src/content/applications/Article')));
...
const routes: RouteObject[] = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                element: <Navigate to="tcbs" replace />
            },
            {
                path: 'tcbs',
                element: <Blank />
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                element: <Navigate to="blank" replace />
            },
            {
                path: 'blank',
                element: <Blank />
