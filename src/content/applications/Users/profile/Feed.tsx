...
function Feed() {
    const feed = [
        ...
        },
        {
            ...
            company: 'Buzzdog',
            avatar: 'https://cdn.topfinapi.com/images/avatars/2.jpg'
        },
        {
            name: 'Rowena Geistmann',
            jobtitle: 'Pharmacist',
            company: 'Yozio',
            avatar: 'https://cdn.topfinapi.com/images/avatars/3.jpg'
        },
        {
            name: 'Ede Stoving',
            jobtitle: 'VP Operations',
            company: 'Cogibox',
            avatar: 'https://cdn.topfinapi.com/images/avatars/4.jpg'
        },
        {
            name: 'Crissy Spere',
            jobtitle: 'Social Worker',
            company: 'Babbleblab',
            avatar: 'https://cdn.topfinapi.com/images/avatars/5.jpg'
        },
        {
            name: 'Michel Greatbanks',
            jobtitle: 'Research Assistant III',
            company: 'Aimbu',
            avatar: 'https://cdn.topfinapi.com/images/avatars/6.jpg'
        }
    ];
